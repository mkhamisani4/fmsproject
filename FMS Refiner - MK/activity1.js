...
var score;
var get; // clicked
var Ypicked = {}; // y values, have to x justify them later
Ypicked[0] = 125;
Ypicked[1] = 190;
Ypicked[2] = 255;
Ypicked[3] = 320;
...
function activity1Draw() {
  ...
  text("Your Score: " + score, 155, 260)
  text(" Time left:  " + timer, 155, 290)
  fill("red")
  textSize(14)
  ...
  if(mouseX>x-45 && mouseX<x+45 && mouseY>y-45 && mouseY<y+45 && frameCount%70<=fullC && get==false)
  {
    score++;
    get=true;
  }
...
function endGame()
{
  ...
  image(wellDone,200,height/0.6,wellDone.width/1.5,wellDone.height/1.7)
}
