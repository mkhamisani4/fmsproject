...
let answer2 = "GLAD";
let answer3 = "ROD";
let correction1 = false;
let correction2 = false;
let correction3 = false;
...
function activity3Setup(){
  ...
  //button.position(checking.x + checking.width - 121, 341);
...
function activity3Draw() {
  ...
  if (correction1 && correction2 || correction2 && correction3 || correction1 && correction3)
    {
      fill("white")
      textSize(21)
  ...
  if (correction1 && correction2 && correction3)
      // no idea how to fix this the previous text isnt like going away
    {
    fill("green")
    textSize(21)
    j = "YOU GOT THEM ALL!"
