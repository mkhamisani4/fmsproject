...
function activity2Draw() {
  ...
  textSize(15);
  fill("yellow");
  text("Click on all the fish that are blue.", 69, 145);
  text("Your goal is to turn all the blue fish", 63, 175);
  text("into yellow fish.", 125, 195);
  ...
  textSize(15);
  text("Click on the blue fish to turn them yellow!", 260, 65);
...
function successScreen() {
  ...
  textSize(30);
  fill("green");
  text("Congrats! You got all the blue fish!", 200, 100);
